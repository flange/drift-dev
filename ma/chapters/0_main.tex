...
\input{01-0_introduction.tex}
\input{01-1_goal.tex}
\input{01-2_structure.tex}
\input{02-0_distProgramming.tex}
\input{02-1_langEvolution.tex}
\input{02-2_distributedObjects.tex}
\input{02-3_actorModel.tex}
\input{03-0_relatedWork.tex}
\input{03-1_languageOfTheSystem.tex}
\input{03-2_cuneiform.tex}
\input{03-3_unix.tex}
\input{03-4_datomic.tex}
\input{03-5_git.tex}
\input{03-6_bretvictor.tex}
\input{04-0_driftIntro.tex}
\input{04-1_importanceofnames.tex}
\input{04-2_driftlang.tex}
\input{04-3_driftimpl.tex}
...
\input{04-3_driftui.tex}
\input{05_futurework.tex}
